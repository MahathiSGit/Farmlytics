...
SOURCES = \
	__init__.py \
	Farmlytics.py Farmlytics_dialog.py

PLUGINNAME = Farmlytics

PY_FILES = \
	__init__.py \
	Farmlytics.py Farmlytics_dialog.py

UI_FILES = Farmlytics_dialog_base.ui
...
QGISDIR=C:\Users\Suresh Sarpamale\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
